// <copyright file="ScaledValidatorTests.cs" company="dsnouck">
...
/// <summary>
/// Provides tests for <see cref="ScaledValidator"/>.
/// </summary>
public class ScaledValidatorTests
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ScaledValidatorTests"/> class.
    /// </summary>
    public ScaledValidatorTests()
    {
    ...
    /// <summary>
    /// Tests <see cref="ScaledValidator"/>.
    /// </summary>
    [Fact]
    public void GivenSceneIsNullWhenValidateIsCalledThenItFails()
    {
        ...
        // Assert.
        result.ShouldHaveValidationErrorFor(sceneContainer => (sceneContainer.Scene as Scaled).Scene);
    }
}
