// <copyright file="UnitedSceneValidatorTests.cs" company="dsnouck">
...
namespace Scenery.ControllersTests.Validators
{
    ...
    /// <summary>
    /// Provides tests for <see cref="UnitedSceneValidator"/>.
    /// </summary>
    public class UnitedSceneValidatorTests
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitedSceneValidatorTests"/> class.
        /// </summary>
        public UnitedSceneValidatorTests()
        {
        ...
        /// <summary>
        /// Tests <see cref="UnitedSceneValidator"/>.
        /// </summary>
        [Fact]
        public void GivenScenesIsNullWhenValidateIsCalledThenItFails()
        {
            ...
            // Assert.
            result.ShouldHaveValidationErrorFor(sceneContainer => (sceneContainer.Scene as UnitedScene).Scenes);
        }
