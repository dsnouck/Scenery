// <copyright file="IntersectedSceneComponent.cs" company="Daniel Snouck">
...
namespace Scenery.Components.Implementations.SceneComponents
{
    ...
    /// <inheritdoc/>
    public class IntersectedSceneComponent : ISceneComponent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IntersectedSceneComponent"/> class.
        /// </summary>
        ...
        public IntersectedSceneComponent(
