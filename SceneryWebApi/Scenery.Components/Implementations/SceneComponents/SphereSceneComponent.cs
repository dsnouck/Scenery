// <copyright file="SphereSceneComponent.cs" company="Daniel Snouck">
...
namespace Scenery.Components.Implementations.SceneComponents
{
    ...
    /// <inheritdoc/>
    public class SphereSceneComponent : ISceneComponent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SphereSceneComponent"/> class.
        /// </summary>
