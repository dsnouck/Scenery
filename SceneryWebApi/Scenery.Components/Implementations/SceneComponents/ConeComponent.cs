// <copyright file="ConeComponent.cs" company="dsnouck">
...
namespace Scenery.Components.Implementations.SceneComponents
{
    ...
    /// <inheritdoc/>
    public class ConeComponent : ISceneComponent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConeComponent"/> class.
        /// </summary>
