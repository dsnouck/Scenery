// <copyright file="SphereSceneComponentTests.cs" company="dsnouck">
...
namespace Scenery.Components.Tests.SceneComponentTests
{
    ...
    /// <summary>
    /// Provides tests for <see cref="SphereSceneComponent"/>.
    /// </summary>
    public class SphereSceneComponentTests
    {
        private readonly SphereSceneComponent systemUnderTest;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SphereSceneComponentTests"/> class.
        /// </summary>
        public SphereSceneComponentTests()
        {
            ...
            this.systemUnderTest = new SphereSceneComponent(
        ...
        /// <summary>
        /// Tests <see cref="SphereSceneComponent.Contains(Vector3)"/>.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests <see cref="SphereSceneComponent.GetAllIntercepts(Line3)"/>.
        /// </summary>
        [Fact]
