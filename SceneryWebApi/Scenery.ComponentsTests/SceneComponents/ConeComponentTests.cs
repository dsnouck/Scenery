// <copyright file="ConeComponentTests.cs" company="dsnouck">
...
/// <summary>
/// Provides tests for <see cref="ConeComponent"/>.
/// </summary>
public class ConeComponentTests
{
    private readonly ConeComponent systemUnderTest;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConeComponentTests"/> class.
    /// </summary>
    public ConeComponentTests()
    {
        ...
        this.systemUnderTest = new ConeComponent(
    ...
    /// <summary>
    /// Tests <see cref="ConeComponent.Contains(Vector3)"/>.
    /// </summary>
    [Fact]
